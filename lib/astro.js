...
async function syncdb() {
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "ᴇꜱ ᴛᴇᴀᴍꜱ-ᴠ2👑") +
        "\n";
      try {
  ...
  AstaConn.messageId = (length = 8, prefix = "𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑") => {
...
let asciiArt =
  "\n\n " + Config.VERSION + "\n ᴇꜱ ᴛᴇᴀᴍꜱ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ\n\n";
...
async function main() {
  ...
  if (
    !global.isMongodb &&
    global.DATABASE_URL &&
    !["false", "null"].includes(global.DATABASE_UɪRL)
  ) {
    try {
