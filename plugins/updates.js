let {
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /2348039607375|2349027862116/g.test(_0x12e4c4.id) ? "𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑" : "" + _0x12e4c4.id.split("@")[0];
 ...
 }); // POWERED BY ES TEAMS, MADE WITH ❤️
 // MORE PLUG-INS : https://whatsapp.com/channel/0029Vaj1vKSK5cDDT4tVvY1y
