    ...
    try {
      ...
      const designs = [
        ...
        async () => {
          ...
          const end = new Date().getTime();
          const pingSeconds = (end - start) / 1000;
          const captionText = `𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑n\n*ʀᴇsᴘᴏɴsᴇ ʀᴀᴛᴇ:* ${pingSeconds} seconds\n\n*Line:*\n${line.result}\n\n𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑`;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared '𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑'!*");
    }
    let _0x1b2187 = "*[𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared '𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent '𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      _0x1a9455.fakeMessage = async (_0x552a47 = "order", _0x3ae380 = {}, _0x5959c0 = "➬ 𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑", _0x433733 = {}) => {
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "2349037524605@s.whatsapp.net"
            }
          };
