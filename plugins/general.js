  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://whatsapp.com/channel/0029Vaj1vKSK5cDDT4tVvY1yd"
      );
      let _0x1c73f9 = (
        "\n𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑 A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        ...
        "\n  *❲❒❳ Repo:* _https://whatsapp.com/channel/0029Vaj1vKSK5cDDT4tVvY1y_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
          ...
          try {
            if (_0x2ecd2a) {
              ...
              if (_0x13a11c.toLowerCase().startsWith("reply")) {
                ...
                let _0x3f6b59 =
                  "*𝔼𝕊 𝕋𝔼𝔸𝕄𝕊-𝕍2👑 • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
